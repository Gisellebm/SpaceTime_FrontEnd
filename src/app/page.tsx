...
export default function Home() {
  return (
    <main className="grid grid-cols-2 min-h-screen">
      {/* left */}
      <div className="flex bg-[url(../assets/bg-stars.svg)] bg-cover flex-col items-start justify-between overflow-hidden px-28 py-16 relative border-r border-white/10">
        {/* blur */}
        ...
        <div className='text-sm leading-relaxed text-gray-200'>
          Feito com 💜 no NLW da{' '} 
          <a className='target-blank underline hover:text-gray-100' href='https://rocketseat.com.br'>
            Rocketseat
          </a>
        </div>
